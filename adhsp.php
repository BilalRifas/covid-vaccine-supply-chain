...
<div id="popup2" class="overlay">
	<div class="popup">
		...
		<a class="close" href="#"><font size="3px">x</font></a>
		<div class="content">
			<br><br>New hospital successfully inserted. Please send Username & Password via email.
		</div>
	</div>
</div>
...
<div class="containerr">
		...
		<form action="adhspsub.php" method="post">
		<input name="srh" type="text" class="other" placeholder="Username"></td><td>
		<input name="search" type="submit" value="Search"/>
		</form>
		</td></tr>
<tr>		
<form name="myform" onSubmit="return validateForm()" action="adhspsub.php" method="post">
<td><label>Hospital Name</label></td><td></td><td><input id="textbox1" name="hnm" type="text" class="other" value="<?php echo $hnm;?>" required></td></tr><tr>
<td><label>Username</label></td><td></td><td><input id="textbox2" onkeyup="
  var start = this.selectionStart;
  var end = this.selectionEnd;
  this.value = this.value.toUpperCase();
  this.setSelectionRange(start, end);
" name="unm" type="text" class="other" value="<?php echo $unm; ?>" required <?php if($unm != ''){ echo 'readonly'; } ?>></td></tr><tr>
<td><label>Password</label></td><td></td><td><input id="textbox3" name="pw" type="text" class="other" value="<?php echo $pw;?>" required></td></tr>
<tr><td></td><td></td><td>
